...
if [ ! -d "yaml" ]; then
    echo "Directory 'yaml' does not exist. Please create it and place your YAML files there."
    exit 1
fi
...
for yaml_file in yaml/*.yaml; do
    if [ -f "$yaml_file" ]; then
        ...
        boltz predict "$yaml_file" --use_msa_server --preprocessing-threads 16 --diffusion_samples 5
    fi
done
